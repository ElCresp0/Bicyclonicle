...
const byte aviHeader[AVI_HEADER_SIZE] = // This is the AVI file header.  Some of these values get overwritten.
    {
        ...
        0x49, 0x4E, 0x46, 0x4F, // 0xCB "INFO"     Additional informations
        0x04, 0x00, 0x00, 0x00, // 0xD0 4         Structure length
        0x00, 0x00, 0x00, 0x00, // 0xD4          If set to 0 video will be erased; 1 will be saved

        0x4C, 0x49, 0x53, 0x54, // 0xD8 "LIST"
        0x00, 0x00, 0x00, 0x00, // 0xDC           Total size of frames        [gets updated later]
        0x6D, 0x6F, 0x76, 0x69  // 0xE0 "movi"
};
